  ...
  <div class="vertical-menu collapse navbar-collapse" id="navbarSupportedContent22">-->
    ...
    <ul class="nav justify-content-center itm">
      <li class="nav-item <?php echo $st;?>">        
         <a class="nav-link" href="<?php echo $raiz; ?>"><!--style="padding: 20px; padding-left: 30px; padding-right: 30px;"-->
          <span><i class="fas fa-tachometer-alt"></i></span>
          <span>Panel</span>
         </a>
      </li>
      <li class="nav-item <?php echo $stilo;?>">
        <a class="nav-link" href="<?php echo $raiz; ?>?submenu=1&page1=1/" >
      ...
      <li class="nav-item <?php echo $stilo2;?>">
        <a class="nav-link" href="<?php echo $raiz; ?>?submenu=1&page3=1/" tabindex="-1" aria-disabled="true">
      ...
      <li class="nav-item <?php echo $stmovs;?>">
        <a class="nav-link" href="<?php echo $raiz; ?>?submenu=1&movs=1/" tabindex="-1" aria-disabled="true">
