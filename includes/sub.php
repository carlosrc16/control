  ...
  <div class="vertical-menu collapse navbar-collapse" id="navbarSupportedContent22">-->
    ...
    <ul class="nav justify-content-center itm">
      <li class="nav-item <?php echo $stilo;?>">        
         <a class="nav-link" href="<?php echo $raiz; ?>?submenu=1&page1=1/" style="padding-left: 30px; padding-right: 30px;"><!--style="padding: 20px; padding-left: 30px; padding-right: 30px;"-->
      ...
      <li class="nav-item <?php echo $stilo2;?>">
        <a class="nav-link" href="<?php echo $raiz; ?>?submenu=1&page3=1/" style="padding-left: 30px; padding-right: 30px;">
